...
# Link the geo-specific backup zone so the VM workloads' Recovery
# Services vault private endpoints resolve from this spoke.
additional_hub_private_dns_zone_names = ["privatelink.uks.backup.windowsazure.com"]

# The production VM workloads sit behind internal load balancers, which
# provide no outbound connectivity: the NAT gateway is their explicit
# outbound path for OS updates and package mirrors.
