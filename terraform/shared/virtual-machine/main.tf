...
# A Linux virtual machine with no public IP address. Reach it over the
# private network, e.g. through Azure Bastion in the hub.
...
# The virtual machine, authenticated with SSH keys only.
resource "azurerm_linux_virtual_machine" "this" {
  ...
  # Secure defaults: SSH keys only, trusted launch and encryption at host.
  # Encryption at host requires the Microsoft.Compute/EncryptionAtHost
...
# Attaches the data disks in the order determined by LUN
