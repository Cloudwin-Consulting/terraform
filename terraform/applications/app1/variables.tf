...
variable "enable_traffic_manager" {
  description = "Whether to deploy a Traffic Manager profile routing to this app."
  type        = bool
  default     = false
}

variable "traffic_manager_dns_name" {
  description = "The globally unique relative DNS name of the Traffic Manager profile. Defaults to <deployment_name>-<environment>."
  type        = string
  default     = null
}
