...
# The health probe a real endpoint answers. Kept off the default path
# from QA onwards so the probe exercises the same endpoint the
# application stacks expose.
