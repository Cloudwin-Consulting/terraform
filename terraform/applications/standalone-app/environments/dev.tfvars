...
# Virtual machines
#
# Development runs one machine in each tier, regionally.
# ------------------------------------------------------------
linux_virtual_machine_count   = 1
windows_virtual_machine_count = 1
availability_zones            = []

linux_virtual_machine_size   = "Standard_B2ms"
...
# Azure SQL
#
# Development puts every database on a single serverless server, which
# pauses when nobody is using it.
# ------------------------------------------------------------
sql_server_count = 1
