...
# Virtual machines
#
# Production scales both tiers out across the three availability
# zones, on general purpose sizes and with Azure Hybrid Benefit
# applied to the Windows machines.
# ------------------------------------------------------------
linux_virtual_machine_count   = 3
windows_virtual_machine_count = 2
availability_zones            = ["1", "2", "3"]

linux_virtual_machine_size   = "Standard_D4s_v5"
windows_virtual_machine_size = "Standard_D4s_v5"
...
# Backup
#
# Production keeps a month of daily restore points, replicated to the
# paired region.
# ------------------------------------------------------------
enable_backup                         = true
...
# Azure SQL
#
# Production splits the databases across two servers, each on a
# zone-redundant provisioned SKU, so a single server is neither the
# blast radius nor the throughput ceiling for the whole application.
# ------------------------------------------------------------
sql_server_count = 2
...
# Web app
#
# Two workers on a zone-redundant Premium v3 plan.
# ------------------------------------------------------------
enable_app_service                 = true
app_service_sku                    = "P1v3"
app_service_worker_count           = 2
app_service_zone_balancing_enabled = true

# Production keeps telemetry for longer than the other environments.
