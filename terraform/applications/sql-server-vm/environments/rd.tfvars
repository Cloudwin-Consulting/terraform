...
# feature-identical to Enterprise, which makes it the right build for
# research and development. It is never licensed for production use.
sql_image_sku        = "sqldev-gen2"
virtual_machine_size = "Standard_E2ds_v5"

# A single small data and log pair is enough to exercise the storage
# layout the higher environments use.
data_disks = [
  {
    name                 = "data"
    disk_size_gb         = 128
