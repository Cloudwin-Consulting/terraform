...
variable "function_app_sku" {
  description = "The SKU of the App Service plan. A dedicated SKU (e.g. P1v3) avoids the Elastic Premium content share, which needs storage access keys."
  type        = string
  default     = "P1v3"
}
...
variable "service_bus_capacity" {
  description = "The number of messaging units of the Premium Service Bus namespace."
  type        = number
  default     = 1
}

variable "function_app_name" {
  description = "The globally unique name of the function app. Defaults to func-<deployment_name>-<environment>."
  type        = string
  default     = null
}
...
variable "service_bus_name" {
  description = "The globally unique name of the Service Bus namespace. Defaults to sb-<deployment_name>-<environment>."
  type        = string
  default     = null
}
