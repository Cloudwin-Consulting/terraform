...
variable "app_integration_subnet_name" {
  ...
  type        = string
  default     = "snet-logic-integration"
}
...
variable "logic_app_sku" {
  description = "The SKU of the Workflow Standard plan."
  type        = string
  default     = "WS1"
}

variable "logic_app_name" {
  description = "The globally unique name of the logic app. Defaults to logic-<deployment_name>-<environment>."
  type        = string
  default     = null
}

variable "storage_account_name" {
  description = "The globally unique name of the runtime storage account. Defaults to st<deployment_name>-<environment> stripped of hyphens, which must stay within the 24 character storage account name limit."
  type        = string
  default     = null
}
